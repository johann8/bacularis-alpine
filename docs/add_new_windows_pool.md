...
cd /tmp
curl  https://raw.githubusercontent.com/johann8/bacularis-alpine/master/add_new_windows_pool_template --output add_new_windows_pool_template
vi add_new_windows_pool_template
